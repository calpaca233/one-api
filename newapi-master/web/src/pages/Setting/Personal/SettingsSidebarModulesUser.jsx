  ...
  const generateDefaultConfig = () => {
    ...
    if (isSidebarSectionAllowed('console')) {
      defaultConfig.console = {
        ...
        tapnow: isSidebarModuleAllowed('console', 'tapnow'),
    ...
    if (isSidebarSectionAllowed('personal')) {
      defaultConfig.personal = {
        ...
        invoiceApplication: isSidebarModuleAllowed('personal', 'invoiceApplication'),
        billingExport: isSidebarModuleAllowed('personal', 'billingExport'),
      };
    }
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          ...
          title: t('发票申请'),
          description: t('申请发票服务'),
        },
        {
          key: 'billingExport',
          title: t('账单导出'),
          description: t('导出使用账单'),
        },
      ],
    },
    {
      ...
      modules: [
        { key: 'channel', title: t('模型厂家管理'), description: t('API渠道配置') },
