...
const SystemSetting = () => {
  ...
  const submitICPNumber = async () => {
    await updateOptions([{ key: 'ICPNumber', value: inputs.ICPNumber }]);
  };

  const submitSystemName = async () => {
    await updateOptions([{ key: 'SystemName', value: inputs.SystemName }]);
  };
            ...
            >
              <Card>
                <Form.Section text={t('通用设置')}>
                  ...
                  >
                    <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                      <Form.Input
                        field='ICPNumber'
                        label={t('备案号')}
                        placeholder={t('在此输入备案号，例如：浙ICP备2025210683号')}
                      />
                    </Col>
                  </Row>
                  <Button onClick={submitICPNumber}>
                    {t('设置备案号')}
                  </Button>
                  <Row
                    gutter={{ xs: 8, sm: 16, md: 24, lg: 24, xl: 24, xxl: 24 }}
                  ...
                  <Button onClick={submitSystemName}>
                    {t('设置系统名称')}
                  </Button>
                </Form.Section>
              </Card>
              ...
              {/* <Card>
                <Form.Section text={t('代理设置')}>
                  ...
                  <Button onClick={submitWorker}>{t('更新 Worker 设置')}</Button>
                </Form.Section>
              </Card>
