...
func HandleGroupRatio(ctx *gin.Context, relayInfo *relaycommon.RelayInfo) types.GroupRatioInfo {
	...
	println(fmt.Sprintf("HandleGroupRatio called: user_id=%d, model=%s, user_group=%s", relayInfo.UserId, relayInfo.OriginModelName, relayInfo.UserGroup))
	...
	if hasUserModelRatio {
		...
		println(fmt.Sprintf("user model ratio applied: user_id=%d, model=%s, ratio=%.4f", relayInfo.UserId, relayInfo.OriginModelName, userModelRatio))
